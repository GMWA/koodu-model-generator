        ...
        <q-menu v-model="menu" style="width: 200px;">
          <q-list>
            <q-item class="menu-item" clickable v-close-popup to="/users/profile">
              ...
              <q-item-section class="enu-label">Profile</q-item-section>
            </q-item>
