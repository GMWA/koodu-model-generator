...
<template>
  <div class="flex flex-col pl-2 w-full">
    ...
    <div class="flex items-center align-middle w-full mt-2 mb-2">
      ...
      >
        <option selected>Choose an attribut</option>
        <option value="US">attributs 1</option>
        <option value="CA">attributs 2</option>
        <option value="FR">attributs 3</option>
        <option value="DE">attributs 4</option>
      </select>
    </div>
    <hr />
