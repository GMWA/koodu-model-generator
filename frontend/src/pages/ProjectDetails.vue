                    ...
                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                        <li class="mr-2">
                            <a
                                ...
                                :class="{'border-blue-600 active text-blue-600 dark:text-blue-500 dark:border-blue-500': activeTab === 'configs', 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300': activeTab !== 'configs'}"
                            >
                                Configs
                            </a>
                        </li>
                        <li class="mr-2">
                            <a
                                ...
                                class="inline-flex p-4 rounded-t-lg border-b-2  group"
                                :class="{'border-blue-600 active text-blue-600 dark:text-blue-500 dark:border-blue-500': activeTab === 'tables', 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300': activeTab !== 'tables'}"
                            >
                                Tables
                            </a>
                        </li>
                        <li class="mr-2">
                            <a
                                ...
                                class="inline-flex p-4 rounded-t-lg border-b-2 group"
                                :class="{'border-blue-600 active text-blue-600 dark:text-blue-500 dark:border-blue-500': activeTab === 'settings', 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300': activeTab !== 'settings'}"
                            >
                                Settings
                            </a>
                        </li>
                        <li class="mr-2">
                            <a
                                ...
                                class="inline-flex p-4 rounded-t-lg border-b-2 group"
                                :class="{'border-blue-600 active text-blue-600 dark:text-blue-500 dark:border-blue-500': activeTab === 'contacts', 'border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300': activeTab !== 'contacts'}"
                            >
                                Contacts
                            </a>
                        </li>
